...
const services = [
  ...
  },
  {
    ...
    description: [
      ...
      "Reliable Through-Hole Assembly",
    ],
  },
  {
    icon: Container,
    ...
    >
      <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-white leading-tight mb-6">
       Leading Electronics Manufacturing Services{" "}
        <span className="text-accent block">(EMS) Partner</span>
      </h1>

      <p className="text-lg md:text-xl text-white/80 mb-8 leading-relaxed max-w-6xl">
       High-precision SMT, THT & Box Build Assembly solutions with advanced manufacturing capabilities, automated inspection systems, and commitment to zero-defect production.
      </p>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
             ...
             SAI TECHNO WORKS is a growing Electronics Manufacturing Services (EMS) company specializing in PCB Assembly, SMT, THT, Box Build Assembly, and end-to-end electronic manufacturing solutions. With advanced production lines, automated inspection systems, and skilled manpower, we deliver reliable, cost-effective, and high-quality manufacturing services.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-card rounded-lg p-6 shadow-card">
                    ...
                    <h4 className="font-semibold text-foreground mb-2">🏭 15,000 Sq.Ft</h4>
                    <p className="text-sm text-muted-foreground">Manufacturing Facility</p>
                  </div>
                  <div className="bg-primary text-primary-foreground rounded-lg p-6">
                    <div className="text-1xl font-bold mb-2">⚙️ 3 SMT Lines
</div>
                    <p className="text-sm text-primary-foreground/80">Automated Production</p>
                  </div>
                </div>
                <div className="space-y-4 pt-8">
                  <div className="bg-accent text-accent-foreground rounded-lg p-6">
                    <div className="text-1xl font-bold mb-2">🔧 2 THT Lines
</div>
                    <p className="text-sm text-accent-foreground/90">Manual Insertion Lines</p>
                  </div>
                  <div className="bg-card rounded-lg p-6 shadow-card">
                    <Settings className="text-accent mb-4" size={32} />
                    <h4 className="font-semibold text-foreground mb-2">🔍 AOI + SPI</h4>
                    <p className="text-sm text-muted-foreground">Advanced Inspection Systems</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="section-padding">
        <div className="container-wide">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="text-accent text-lg uppercase tracking-wider font-bold">
Our Core Manufacturing Services            </span>
            <h2 className="section-title mt-2">
           Integrated Engineering Solutions
            </h2>
            <p className="section-subtitle mx-auto">
Sai Techno Works provides end-to-end Electronics Manufacturing Services (EMS), from PCB assembly and component placement to box build integration, testing, and quality assurance.            </p>
          </div>
